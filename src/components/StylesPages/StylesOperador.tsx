...
export const WrapperOperador = styled.section`
  width: 100%;
  display: flex;
...
`
export const ButtonOperador = styled.button`
  width: 100%;
  display: flex;
  flex-direction: row;
...
`
export const DisplayIconOperador = styled.div`
  font-size: 2rem;
  color: ${props => props.theme.colors.colorC};
  display: flex;
  justify-content: center;
...
`
export const ScreenCheckOperador = styled.div`
  width: 100%;
  height: 100%;
  display: grid;
  place-items: center;

...
export const WrapperConexao = styled.section`
  width: 100%;
  display: flex;
...
`
export const ContentConexao = styled.div`
  width: 100%;
  display: flex;
  flex-direction: column;
  justify-content: flex-start;
...
`
export const BlockConexao = styled.div`
  width: 100%;
  display: flex;
  flex-direction: row;
  justify-content: flex-start;
...
`
export const ButtonConexao = styled.button`
  width: 100%;
  max-width: 20rem;
  display: flex;
  flex-direction: row;
...
`
export const DisplayIconConexao = styled.div`
  font-size: 2rem;
  color: ${props => props.theme.colors.colorC};
  display: flex;
  justify-content: center;
...
`
export const ScreenCheckConexao = styled.div`
  width: 100%;
  height: 100%;
  display: grid;
  place-items: center;
